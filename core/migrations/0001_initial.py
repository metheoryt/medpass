# Generated by Django 3.0.5 on 2020-04-08 09:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('citizenship', models.ForeignKey(default=1085, on_delete=django.db.models.deletion.CASCADE, to='core.Country', verbose_name='Гражданство')),
            ],
        ),
        migrations.CreateModel(
            name='Vehicle',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('add_date', models.DateTimeField(auto_now=True)),
                ('checkpoint', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='policemans', to='core.Checkpoint')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='persons',
            field=models.ManyToManyField(related_name='passes', through='core.PersonPassData', to='core.Person'),
        ),
        migrations.AddField(
            model_name='checkpointpass',
            name='policeman',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.Policeman'),
        ),
        migrations.AddField(
            model_name='checkpointpass',
            name='vehicle',
