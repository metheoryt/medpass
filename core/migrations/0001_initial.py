...
def default_groups(apps, schema_editor):
    ...
    Group.objects.create(name='inspectors')
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_date', models.DateField(help_text='YYY-MM-DD', verbose_name='дата рождения')),
                ...
                ('citizenship', models.CharField(blank=True, help_text='гражданин какой страны?', max_length=256, null=True, verbose_name='гражданство')),
                ...
                ('residence_place', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='residents', to='core.Place', verbose_name='место проживания')),
                ('study_place', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='students', to='core.Place', verbose_name='место учебы')),
            ],
            options={
                'abstract': False,
            },
